 ...
 * ```
 */
declare abstract class JSONSchemaFormDataProvider<S extends ContextItemSchema = ContextItemSchema, EC extends JinjaExternalContext = JinjaExternalContext> extends JSONSchemaDataProvider<S, EC> {
    fields: object;
