...
class NonCollinearMagnetizationContextProvider extends _JSONSchemaFormDataProvider.default {
    constructor(config) {
        ...
        this.isStartingMagnetization = _lodash.default.get(
            this.data,
            "isStartingMagnetization",
            true,
        );
        this.isConstrainedMagnetization = _lodash.default.get(
            this.data,
            "isConstrainedMagnetization",
            false,
        );
        this.isExistingChargeDensity = _lodash.default.get(
            this.data,
            "isExistingChargeDensity",
            false,
        );
        this.isArbitrarySpinDirection = _lodash.default.get(
            this.data,
            "isArbitrarySpinDirection",
            false,
        );
        this.isFixedMagnetization = _lodash.default.get(this.data, "isFixedMagnetization", false);
        this.constrainedMagnetization = _lodash.default.get(
            this.data,
