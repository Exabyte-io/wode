...
class PointsGridFormDataProvider extends _JSONSchemaFormDataProvider.default {
    constructor(config) {
        ...
        this.gridMetricValue =
            _lodash.default.get(this.data, "gridMetricValue") ||
            this._getDefaultGridMetricValue("KPPRA");
    ...
    get reciprocalVectorRatios() {
        return this.reciprocalLattice.reciprocalVectorRatios.map((r) =>
            Number(_math.math.numberToPrecision(r, 3)),
        );
    }
    get jsonSchema() {
        const vector = {
    ...
    calculateDimensions({ gridMetricType, gridMetricValue, units = _constants.units.angstrom }) {
    ...
    calculateGridMetric({ gridMetricType, dimensions, units = _constants.units.angstrom }) {
        switch (gridMetricType) {
            case "KPPRA":
                return this._getKPPRAFromDimensions(dimensions);
            case "spacing":
                return _lodash.default.round(
