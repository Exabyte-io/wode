...
class ExecutionUnit extends _base.BaseUnit {
  ...
  get hashFromArrayInputContent() {
    const objectForHashing = this._getInput().map(i => {
      return (0, _utils.removeEmptyLinesFromString)((0, _utils.removeCommentsFromSourceCode)(i.content));
    });
    return (0, _utils.calculateHashFromObject)(objectForHashing);
  }
  get name() {
  ...
  getHashObject() {
    return {
      ...super.getHashObject(),
      application: (0, _utils.removeTimestampableKeysFromConfig)(this.application.toJSON()),
      executable: (0, _utils.removeTimestampableKeysFromConfig)(this.executable.toJSON()),
      flavor: (0, _utils.removeTimestampableKeysFromConfig)(this.flavor.toJSON()),
