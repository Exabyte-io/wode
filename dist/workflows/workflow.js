...
function _toPrimitive(t, r) { if ("object" != typeof t || !t) return t; var e = t[Symbol.toPrimitive]; if (void 0 !== e) { var i = e.call(t, r || "default"); if ("object" != typeof i) return i; throw new TypeError("@@toPrimitive must return a primitive value."); } return ("string" === r ? String : Number)(t); } /* eslint-disable max-classes-per-file */ // import { createSubworkflowByName } from "../subworkflows";
const {
  MODEL_NAMES
} = _mode.tree;
...
class Workflow extends BaseWorkflow {
  ...
  calculateHash() {
    ...
    return (0, _utils.calculateHashFromObject)(meaningfulFields);
  }
}
